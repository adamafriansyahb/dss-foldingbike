    ...
    <div class="row">
        <div class="col-lg-6">
            <?php if ($consistency['consistency_ratio'] > 1 / 10 or $consistency['consistency_ratio'] < 0) : ?>
                ...
                <a class="btn btn-primary mb-5" href="<?= base_url('brand/compare'); ?>">Reinput value</a>

            <?php else : ?>
                <div class='alert alert-success' role='alert'>The assessment is consistent. You can see the result.</div>
                <a class="btn btn-primary mb-5" href="<?= base_url('result/index'); ?>">See result</a>
            <?php endif; ?>
